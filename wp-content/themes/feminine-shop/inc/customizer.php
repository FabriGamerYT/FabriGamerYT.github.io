...
function feminine_shop_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'feminine_shop_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/feminine-wordpress-theme/">GET PRO</a>','feminine-shop'),
		'panel' => 'feminine_shop_panel_id'
	) );
	...
	'choices' => array(
      '0' =>  esc_attr('0','feminine-shop'),
      '0.1' =>  esc_attr('0.1','feminine-shop'),
      '0.2' =>  esc_attr('0.2','feminine-shop'),
      '0.3' =>  esc_attr('0.3','feminine-shop'),
      '0.4' =>  esc_attr('0.4','feminine-shop'),
      '0.5' =>  esc_attr('0.5','feminine-shop'),
      '0.6' =>  esc_attr('0.6','feminine-shop'),
      '0.7' =>  esc_attr('0.7','feminine-shop'),
      '0.8' =>  esc_attr('0.8','feminine-shop'),
      '0.9' =>  esc_attr('0.9','feminine-shop')
	),'active_callback' => 'feminine_shop_default_slider'
	));
   ...
   $wp_customize->add_setting('feminine_shop_slider_image_overlay_color', array(
	...
	$wp_customize->add_control('feminine_shop_welcome_to_premium_btn',array(
		'description' => "<a class='go-pro' target='_blank' href='". admin_url('themes.php?page=feminine_shop_guide') ." '>More Info</a>",
		'section'=> 'feminine_shop_welcome_to_premium',
		'type'=> 'hidden'
	));
	...
	$wp_customize->add_section('feminine_shop_about_section',array(
		...
		'description' => __('For more options of about section <br/><a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/feminine-wordpress-theme/">GET PRO</a>','feminine-shop'),
		'panel' => 'feminine_shop_panel_id',
	));
	...
	$wp_customize->add_section('feminine_shop_footer',array(
		...
		'description' => __('For more options of footer section <br/><a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/feminine-wordpress-theme/">GET PRO</a>','feminine-shop'),
		'panel' => 'feminine_shop_panel_id',
	));	
	...
	$wp_customize->add_control('feminine_shop_footer_padding',array(
     ...
     // footer social icon
  	...
  	$wp_customize->add_control( new Feminine_Shop_Toggle_Switch_Custom_Control( $wp_customize, 'feminine_shop_footer_icon',array(
		'label' => esc_html__( 'Footer Social Icon','feminine-shop' ),
		'section' => 'feminine_shop_footer'
    )));
