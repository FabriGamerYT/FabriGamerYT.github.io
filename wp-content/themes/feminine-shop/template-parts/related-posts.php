                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
                        <div class="post-main-box">
                            ...
                            <?php if( get_theme_mod('feminine_shop_button_text','Read More') != ''){ ?>
                                <div class="more-btn">
                                    <a href="<?php echo esc_url(get_permalink()); ?>"><?php echo esc_html(get_theme_mod('feminine_shop_button_text',__('Read More','feminine-shop')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('feminine_shop_button_text',__('Read More','feminine-shop')));?></span></a>
                                </div>
                            <?php } ?>
                        </div>
